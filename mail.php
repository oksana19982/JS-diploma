...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на бронирование столика для ' . '. Его телефон: ' . $phone;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("oksana.pavlyuk1998@gmail.com", 'Запрос на бронирование столика', $content);
